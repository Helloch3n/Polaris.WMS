...
public class MiscInboundOrder: FullAuditedAggregateRoot<Guid>
{
    ...
    private readonly List<MiscInboundOrderDetail> _details = new();
    public IReadOnlyCollection<MiscInboundOrderDetail> Details => _details;

    protected MiscInboundOrder()
    {
    }

    internal MiscInboundOrder(
        Guid id,
        string orderNo,
        Guid accountAliasId,
        ...
        string? remark = null) : base(id)
    {
        ...
        Type = MiscOperationType.Inbound;
        Status = MiscOrderStatus.Draft;
        Remark = remark;
    }

    public static MiscInboundOrder Create(
        Guid id,
        string orderNo,
        Guid accountAliasId,
        string accountAliasDescription,
    ...
    public MiscInboundOrderDetail AddDetail(
        Guid detailId,
        Guid warehouseId,
        ...
        string? remark = null)
    {
        ...
        var detail = new MiscInboundOrderDetail(
            detailId,
            Id,
            warehouseId,
            warehouseCode,
        ...
        string? remark = null)
    {
        ...
        if (detail == null)
        {
            throw new BusinessException("其他入库明细不存在").WithData("DetailId", detailId);
        }
    ...
    public void Execute()
    {
        ...
        if (_details.Count == 0)
        {
            throw new BusinessException("其他入库单至少需要一条明细");
        }
