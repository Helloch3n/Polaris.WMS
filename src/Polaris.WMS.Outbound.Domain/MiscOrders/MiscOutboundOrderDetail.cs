...
public class MiscOutboundOrderDetail : Entity<Guid>
{
    public Guid MiscOutboundOrderId { get; private set; }
    ...
    protected MiscOutboundOrderDetail()
    {
    }

    internal MiscOutboundOrderDetail(
        Guid id,
        Guid miscOutboundOrderId,
        Guid warehouseId,
    ...
    {
        MiscOutboundOrderId = miscOutboundOrderId;
