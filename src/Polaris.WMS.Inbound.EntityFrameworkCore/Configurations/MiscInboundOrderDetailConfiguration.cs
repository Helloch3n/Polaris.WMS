...
public class MiscInboundOrderDetailConfiguration : IEntityTypeConfiguration<MiscInboundOrderDetail>
{
    public void Configure(EntityTypeBuilder<MiscInboundOrderDetail> builder)
    {
        builder.ConfigureByConvention();
        builder.ToTable("AppMiscInboundOrderDetails");
        ...
        builder.HasIndex(x => x.MiscInboundOrderId);
