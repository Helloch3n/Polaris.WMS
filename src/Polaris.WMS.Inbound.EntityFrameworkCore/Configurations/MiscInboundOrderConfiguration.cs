...
public class MiscInboundOrderConfiguration : IEntityTypeConfiguration<MiscInboundOrder>
{
    public void Configure(EntityTypeBuilder<MiscInboundOrder> builder)
    {
        builder.ConfigureByConvention();
        builder.ToTable("AppMiscInboundOrders");
        ...
        builder.HasMany(x => x.Details)
            .WithOne()
            .HasForeignKey(x => x.MiscInboundOrderId)
            .IsRequired()
            .OnDelete(DeleteBehavior.Cascade);

        builder.Metadata.FindNavigation(nameof(MiscInboundOrder.Details))?
