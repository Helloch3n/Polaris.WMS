...
using Polaris.WMS.MasterData.Domain;
using Volo.Abp.Application;
using Volo.Abp.Mapperly;
using Volo.Abp.Modularity;

namespace Polaris.WMS.MasterData.Application;

[DependsOn(
    typeof(AbpDddApplicationModule), // 1. 依赖 ABP 核心应用层基础包
    typeof(PolarisWmsMasterDataDomainModule), // 2. 依赖本模块的 Domain 层
...
public class PolarisWmsMasterDataApplicationModule : AbpModule
{
}